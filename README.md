# Advent of Code ⛄
This is a repo to host my Advent of Code solutions. I personally value readability over pure efficiency, which is reflected in my code. Only if performance starts to become an issue (in the context of this challenge that would be an execution time of more than a couple of seconds) do I sacrifice readability for optimization. 
...
|[Day 18](2023/AoC_2023_Day_18.ipynb)|-|-|-|-|-|-|
|-|-|-|-|-|-|-|
